...
def version():
    return "1"
    # 1: reworked some internals for better mqtt control
...
class LedMatrix:
    ...
    def burst(self,empty=6):
        self.led[random.getrandbits(8)] = (random.getrandbits(1),random.getrandbits(1),random.getrandbits(1))
        for i in range(empty):
            self.led[random.getrandbits(8)] = (0,0,0)
        self.led.write()
